...
exports.setAddUserPoints = exports.getUserPoints = exports.createUsers = void 0;
...
function setAddUserPoints(username, cant, type, comment) {
    return __awaiter(this, void 0, void 0, function () {
        var active, validate, userAddPoints;
        return __generator(this, function (_a) {
            ...
            userAddPoints = users_1.setAddUserPointsDb(username, cant, type, comment);
            return [2 /*return*/, userAddPoints];
        });
    });
}
exports.setAddUserPoints = setAddUserPoints;
